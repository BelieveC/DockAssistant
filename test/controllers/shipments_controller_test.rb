...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { appointment_id: @shipment.appointment_id, dock_worker_id: @shipment.dock_worker_id } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { appointment_id: @shipment.appointment_id, dock_worker_id: @shipment.dock_worker_id } }
