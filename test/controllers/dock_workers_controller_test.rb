...
class DockWorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dock_worker" do
    assert_difference('DockWorker.count') do
      post dock_workers_url, params: { dock_worker: { address: @dock_worker.address, archived: @dock_worker.archived, first_name: @dock_worker.first_name, last_name: @dock_worker.last_name, pay_rate: @dock_worker.pay_rate, state_id: @dock_worker.state_id, zipcode: @dock_worker.zipcode } }
    end
